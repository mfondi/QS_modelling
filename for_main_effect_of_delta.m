...
% figure(9)
% plot( Ys(:,3)./Ys(end,3),Ys(:,1)./Ys(end,1), '--', 'LineWidth', 2, 'Color', colors(i,:),'HandleVisibility','off');
% hold on
% plot( Y2s(:,3)./Y2s(end,3),Y2s(:,1)./Y2s(end,1), 'LineWidth', 2, 'Color', colors(i,:));
% hold on
...
figure(161)
subplot(1,3,2);
plot(1:1:length(l), RT_1_array, 'o-', 'LineWidth', 2, 'MarkerSize', 10, 'Color', 'm');
hold on 
plot(1:1:length(l), RT_2_array, 'o-', 'LineWidth', 2, 'MarkerSize', 10, 'Color', 'y');
ylabel('Response time (min)', 'FontSize',18);
...
set(gca,'XTickLabel',l, 'FontSize',10);

title(leg, 'Delta values (h^-1)');

saveas(figure(161),'../../text/delta_m1vsm2.pdf');
...
figure(181)
plot(1:1:length(l), RT_1_array, 'o-', 'LineWidth', 2, 'MarkerSize', 10);
hold on 
plot(1:1:length(l), RT_2_array, 'o-', 'LineWidth', 2, 'MarkerSize', 10);
ylabel('Response time (min)', 'FontSize',18);
xlabel('Growth rate (h^-1)', 'FontSize',18);
set(gca,'XTickLabel',l, 'FontSize',14);
