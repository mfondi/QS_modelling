%% How do the two systems respond to different OACP production rates?
...
saveas(figure(1),'../../text/comparison_OACP_M1.pdf');
...
saveas(figure(2),'../../text/comparison_OACP_M2.pdf');
